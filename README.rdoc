...
There may be times when you don't want to automatically send the invitation email.  You can use <tt>invite_without_notification!</tt> to create the invitation without sending the invitation email.
  User.invite_without_notification!(:email => "new_user@example.com", :name => "John Doe")
  # => the user and invitation token will be created, but an email will not be sent
